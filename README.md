...
<h1>osTicket - Installation and use.</h1>
I demonstrate my ability to install and utilize the popular ticket system called OSTicket.<br />
...
<p>I have installed OSticket on an Azure VM.   
  ...
  FGirst I setup a Web Server: I then Installed and configure the web server (Apache, IIS, or Nginx) on my virtual machine.
